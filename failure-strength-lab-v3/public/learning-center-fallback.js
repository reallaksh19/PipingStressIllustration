const FALLBACK_LEARNING = {
  ...
  Bourdon: {
    ...
    helpers: [
      ['Pressure-driven opening', 'pressure + curvature', 'The Bourdon visual teaches that internal pressure in a curved bend can create a bend-opening cue. Pressure is the driver; there is no separate elbow-flexibility slider.', 'In piping, this is a useful analogy for pressure-induced displacement/reaction sensitivity in curved components, elbows, bends, and nearby terminals.', 'Pressure boundary design belongs to the 304 family; flexibility/reaction interpretation belongs to 319/support modelling. This tab is qualitative only.', 'Do not treat Bourdon opening as thermal expansion or a generic load-source slider.', 'Use end-condition helper to decide whether movement becomes reaction.'],
      ['End condition', 'free / guided / restrained', 'A free end mostly moves. A guided or restrained end can convert opening movement into reaction load at a support, anchor, or equipment nozzle.', 'Nozzle load checks and support reactions depend on boundary stiffness, guide gaps, anchors, line stops, friction, and connected equipment flexibility.', 'Map terminal/reaction interpretation to flexibility analysis, support/restraint modelling, and project nozzle-load criteria; verify against licensed B31.3 and project specs.', 'Do not assume every bend-opening displacement becomes a high nozzle load; boundary condition controls it.', 'Use Load Types and Pipe Expansion to separate pressure-driven and thermal-driven displacement.'],
      ['Bend geometry', '45 / 90 / 180', 'Bend angle changes the visible movement path and reaction sensitivity. A 45°, 90°, and 180° bend should not be interpreted as the same mechanism scale.', 'Curved geometry, ovalisation, wall thickness, bend radius, pressure, connected straight legs, and restraint layout all affect the real response.', 'Detailed elbow/bend treatment is model-dependent and may require flexibility/SIF factors, Appendix D/B31J-type interpretation, and software/project method.', 'Do not use the displayed bend angle as a code-certified elbow flexibility factor.', 'Use Combined Stress only after the pressure/flexibility boundary is clear.'],
      ['B31.3 lens for Tab 7', 'pressure/flexibility boundary', 'Tab 7 separates pressure-driven bend opening from thermal ΔL and from generic load classification.', 'A practical workflow checks pressure design, flexibility, support/nozzle reactions, operating cases, and occasional cases separately.', 'Initial map: 304 pressure design, 319 flexibility, 321 supports/restraints, 302.3.5 stress categories, and Appendix D/B31J where applicable. Educational paragraph map only.', 'Do not claim B31.3 compliance from the Bourdon visual. It has no actual dimensions, material, SIF, bend radius, or restraint stiffness.', 'Next rollout should move to Combined Stress after load route and stress names are stable.']
    ]
  },
  Combined: {
